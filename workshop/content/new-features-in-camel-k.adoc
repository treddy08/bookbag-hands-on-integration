...
+
++++
<a href="#" onclick="parent.send_to_terminal('oc get csv', 1); return false;">Execute</a>
++++
+
[source,bash]
----
...
+
++++
<a href="#" onclick="parent.send_to_terminal('oc create namespace openshift-serverless', 1); return false;">Execute</a>
++++
